...
const Projects = () => {
    return (
        <div id='projects'>
            <div className="project bg-neutral-50 md:py-36 py-20">
                <h1 className="heading  text-center md:pb-36 pb-20 uppercase text-neutral-800 font-semibold text-xl">
                    My Projects
                </h1>

                <div className="projectCards flex flex-col md:gap-36 gap-10 md:px-36 px-5">
                    ...
                    <div className='projectcard rounded-xl bg-neutral-800'>
                        <div className='flex md:flex-row flex-col items-center justify-around'>
                            <div className="skills p-5 md:ps-5 md:w-1/4">
                                ...
                                <h1 className="uppercase text-neutral-300 leading-relaxed text-md">
                                    Tech used: Html, Css, JavaScript, React and Tailwind
                                </h1>
                                <h1 className="pt-5 text-neutral-500 leading-relaxed text-md">

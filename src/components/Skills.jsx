    ...
    return (
        <div className='bg-neutral-50 flex justify-between md:p-20 p-7' id='skills'>
            ...
            <div className="skills md:ps-28 md:w-1/2">
                ...
                <button className='font-semibold mt-5 transition ease-in-out duration-300 md:px-5 px-3 py-2 text-neutral-800 border border-neutral-800 bg-white hover:text-white hover:bg-neutral-800 hover:border-white rounded-full'>Get My Resume</button>

    ...
    return (
        <div className='bg-neutral-50 flex justify-between md:p-20 p-7' id='skills'>
            ...
            <div className="skills lg:ps-28 lg:w-1/2">
                ...
                <button className='mt-5 transition ease-in-out duration-300 md:px-5 px-3 py-2 text-neutral-800 border border-neutral-800 bg-white hover:text-white hover:bg-neutral-800 hover:border-white rounded-full'><a href="./Tabish Resume.pdf" download>Get My Resume</a></button>
